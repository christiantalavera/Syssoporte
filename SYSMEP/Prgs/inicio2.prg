...
PROCEDURE Crea_Menu
	...
	*SET SYSMENU AUTOMATIC
	...
	DEFINE MENU MnuPrincipal BAR IN WINDOW FrmPrincipal
	 ...
	 SCAN ALL
	  ...
	  ENDIF  
	    ...
	    lcPromp = IIF(m.estado='A',"'","'\") + " " + ALLTRIM(m.des_menuniv1) + "'"
	      ...
	      Define Pad &lcPad OF MnuPrincipal Prompt &lcPromp  COLOR SCHEME 3   
	   ...
	   SELECT * FROM menu_niv02 ;
	    ...
	    SELECT menu_niv01
	              ...
	              On Pad  &lcOnPad  Of MnuPrincipal Activate Popup  &lcNamePopup
...
PROCEDURE SETEAR_PANTALLA
	*** SETEANDO DATOS DE LA PANTALLA
	...
	_screen.AddObject("CMDbOTON","CommandButton")
	_screen.cmdboton.visible=.t.
