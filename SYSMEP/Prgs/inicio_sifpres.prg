...
SET SYSMENU OFF
ON SHUTDOWN DO SalirSistema IN inicio_sifpres.prg
...
********************
	...
	*-- Instrucciones DECLARE DLL para leer/escribir en archivos INI privados-
	...
	gcOldTalk="ON"
	gcFileIni = 'cert.ini'
	gcSession = "PARAMETROS DEL SIFPRES"
	gcnom_fuente = 'RUBRO'
...
PROCEDURE SETEAR_PANTALLA
	*** SETEANDO DATOS DE LA PANTALLA
	...
	_screen.Caption 	= 'SIFPRES ' +gcversion+space(2)+CHR(91)+gcsec_ejec+CHR(93)+SPACE(2)+gcNombre_ejecutora
