...
IF !INDBC('CONCEPTO_CLASIFICADOR', 'TABLE') THEN
	CREATE TABLE concepto_clasificador (;
		ano_eje				c(4) NOT NULL, ;
		sec_ejec			c(6) NOT NULL, ;
		concepto			c(4) NOT NULL, ;
		id_clasificador		c(7) NOT NULL, ;
...
IF !INDBC('RECIBO_INGRESO_DET', 'TABLE') THEN
	CREATE TABLE RECIBO_INGRESO_DET (;
		ano_eje				c(4)  NOT NULL, ;
		sec_ejec			c(6)  NOT NULL, ;
		recibo				c(10) NOT NULL, ;
...
WAIT 'Creando Tabla : MENU_NIV01' WINDOW NOWAIT
IF !INDBC('MENU_NIV01', 'TABLE') THEN
	CREATE TABLE MENU_NIV01 (;
		cuser_id			c(8) NOT NULL, ;
		id_menuniv01		c(5) NOT NULL, ;
		des_menuniv1		c(50) NOT NULL, ;		
		estado				c(1) DEFAULT 'A' )
ENDIF
ALTER TABLE MENU_NIV01 ADD PRIMARY KEY cuser_id+id_menuniv01 TAG id_menu
**PLANTILLA INICIAL**
SELECT MENU_NIV01
INSERT INTO MENU_NIV01 (CUSER_ID, id_menuniv01,des_menuniv1, ESTADO) ;
VALUES ('00000000','00001','Sistemas','A')


WAIT 'Creando Tabla : MENU_NIV02' WINDOW NOWAIT
IF !INDBC('MENU_NIV02', 'TABLE') THEN
	CREATE TABLE MENU_NIV02 (;
		cuser_id			c(8) NOT NULL, ;
		id_menuniv01		c(5) NOT NULL, ;
		id_menuniv02		c(5) NOT NULL, ;
		des_menuniv2		c(50) NOT NULL, ;	
		ejecutaniv2			c(80) NOT NULL, ;			
		tipo_nodoniv2		c(1) NOT NULL, ;
		estado				c(1) DEFAULT 'A' )
ENDIF
ALTER TABLE MENU_NIV02 ADD PRIMARY KEY cuser_id+id_menuniv01+id_menuniv02 TAG menu_niv2

WAIT 'Creando Tabla : MENU_NIV03' WINDOW NOWAIT
IF !INDBC('MENU_NIV03', 'TABLE') THEN
	CREATE TABLE MENU_NIV03 (;
		cuser_id			c(8) NOT NULL, ;
		id_menuniv01		c(5) NOT NULL, ;
		id_menuniv02		c(5) NOT NULL, ;
		id_menuniv03		c(5) NOT NULL, ;
		des_menuniv3		c(50) NOT NULL, ;	
		ejecutaniv3			c(80) NOT NULL, ;					
		estado				c(1) DEFAULT 'A' )
ENDIF
ALTER TABLE MENU_NIV03 ADD PRIMARY KEY cuser_id+id_menuniv01+id_menuniv02+id_menuniv03 TAG id_menu

WAIT 'Creando Tabla : ENTIDAD_USUARIA' WINDOW NOWAIT
IF !INDBC('ENTIDAD_USUARIA', 'TABLE') THEN
	CREATE TABLE ENTIDAD_USUARIA(;
		RUC					c(11) 	NOT NULL, ;
		nombre				c(150)  NULL , ;
		estado				c(1) DEFAULT 'A' )
ENDIF
ALTER TABLE ENTIDAD_USUARIA ADD PRIMARY KEY ruc TAG ruc


WAIT 'Creando Tabla : TIPO_VIATICO' WINDOW NOWAIT
IF !INDBC('TIPO_VIATICO', 'TABLE') THEN
	CREATE TABLE TIPO_VIATICO (;
		TIPO_VIATICO		c(3) 	NOT NULL, ;
		nombre				c(150)  NULL , ;
		estado				c(1) DEFAULT 'A' )
ENDIF
ALTER TABLE TIPO_VIATICO ADD PRIMARY KEY tipo_viatico TAG tipo

WAIT 'Creando Tabla : TIPO_MEDIO_TRANSPORTE' WINDOW NOWAIT
IF !INDBC('TIPO_MEDIO_TRANSPORTE', 'TABLE') THEN
	CREATE TABLE TIPO_MEDIO_TRANSPORTE(;
		TIPO_MEDIO_TRANSPORTE		c(3) 	NOT NULL, ;
		nombre						c(150)  NULL , ;
		estado						c(1) DEFAULT 'A' )
ENDIF
ALTER TABLE TIPO_MEDIO_TRANSPORTE ADD PRIMARY KEY TIPO_MEDIO_TRANSPORTE TAG tipo



WAIT 'Creando Tabla : CODIGOS' WINDOW NOWAIT
IF !INDBC('CODIGOS', 'TABLE') THEN
	CREATE TABLE CODIGOS(;
		nro_documento		c(10) 	NOT NULL, ;
		des_documento		c(50)  NULL  )
ENDIF
ALTER TABLE CODIGOS ADD PRIMARY KEY ALLTRIM(des_documento) TAG tipo



WAIT 'Creando Tabla : VIATICO' WINDOW NOWAIT
IF !INDBC('VIATICO', 'TABLE') THEN
	CREATE TABLE VIATICO(;
		ano_eje						c(4)	NOT NULL, ;
		sec_ejec					c(6) 	NOT NULL, ;
		viatico						c(10)	NOT NULL, ;
		fuente_financ				c(2)	NULL, ;
		ruc							c(11)	NULL, ;
		tipo_viatico				c(3)	NULL, ;
		TIPO_MEDIO_TRANSPORTE		c(3) 	NULL, ;
		ano_viatico					c(4)	NULL, ;
		mes_viatico					c(2)	NULL, ;
		id_centro_costo				c(6)	NULL, ;
		comisionado					c(150)  NULL , ;
		fecha_salida				d		NULL , ;
		fecha_retorno				d		NULL , ;
		itinerario					c(200)  NULL , ;
		autorizacion				c(150)  NULL , ;
		monto_nacional_pasajes		N(19,2) NULL , ;
		monto_nacional_viaticos		N(19,2) NULL , ;
		nro_resolucion				c(30)	NULL , ;
		estado						c(1) DEFAULT 'A' )
ENDIF
ALTER TABLE VIATICO ADD PRIMARY KEY ano_eje+sec_ejec+viatico TAG viatico

SELECT CODIGOS
INSERT INTO CODIGOS (NRO_DOCUMENTO,DES_DOCUMENTO)  ;
VALUES('0000000001','VIATICO')

SELECT TIPO_MEDIO_TRANSPORTE
INSERT INTO TIPO_MEDIO_TRANSPORTE(TIPO_MEDIO_TRANSPORTE,NOMBRE,ESTADO)  ;
VALUES('001','Aéreo','A')
INSERT INTO TIPO_MEDIO_TRANSPORTE(TIPO_MEDIO_TRANSPORTE,NOMBRE,ESTADO)  ;
VALUES('002','Terrestre','A')
INSERT INTO TIPO_MEDIO_TRANSPORTE(TIPO_MEDIO_TRANSPORTE,NOMBRE,ESTADO)  ;
VALUES('003','Fluvial','A')

SELECT TIPO_VIATICO
INSERT INTO TIPO_VIATICO(TIPO_VIATICO,NOMBRE,ESTADO)  ;
VALUES('001','NACIONAL','A')
INSERT INTO TIPO_VIATICO(TIPO_VIATICO,NOMBRE,ESTADO)  ;
VALUES('002','EXTRANJERO','A')
